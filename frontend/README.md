...
### ¿Qué tienes que personalizar de este código?
1. En el paso 1 de las instrucciones (`git clone...`), cambia `TU_USUARIO` y `TU_REPOSITORIO` por los enlaces reales de tu GitHub.
2. Si quieres, al final del todo en **Autor**, puedes poner tu nombre o un enlace a tu perfil de LinkedIn.
